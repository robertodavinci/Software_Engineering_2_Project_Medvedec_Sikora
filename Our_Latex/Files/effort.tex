...
\hline
\cellcolor[HTML]{C0C0C0}\textbf{Task Description}                                                   & \cellcolor[HTML]{C0C0C0}\textbf{Time spent{[}hours{]}} \\ \hline
\begin{tabular}[c]{@{}l@{}}Introduction:\\ \\ \end{tabular} &                                                       6 \\ \hline
\begin{tabular}[c]{@{}l@{}}Overall description:\\ Product perspective and functions, user characteristics, and constraints\end{tabular} & 4 \\ \hline
\begin{tabular}[c]{@{}l@{}}Overall description:\\ Goals, Assumptions, and Dependencies\end{tabular} &                                                       3 \\ \hline
\begin{tabular}[c]{@{}l@{}}Specific requirements:\\ External interface Requirements\end{tabular}    &                                                       2 \\ \hline
\begin{tabular}[c]{@{}l@{}}Specific requirements:\\ Use Case diagrams\end{tabular}                  &                                                       3 \\ \hline
\begin{tabular}[c]{@{}l@{}}Formal analysis using Alloy:\\ \\ \end{tabular} &                                                       2 \\ \hline
\begin{tabular}[c]{@{}l@{}}LaTex document composition:\\ \\ \end{tabular} &                                                       4 \\ \hline
